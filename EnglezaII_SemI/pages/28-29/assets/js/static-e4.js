function static_click2(data_obj) {
...
static_click2.prototype.init = function() {
...
static_click2.prototype.add_events = function() {
    _this = this;
...
$(document).ready(function() {
    var item_static_click2 = new static_click2(obj_static_ex4);

    $('.static_container').on('vclick', function(e) {
        e.preventDefault();

        if ($(this).attr('data-gameId') == 'item_static_click2') {
            item_static_click2.init();
        }
