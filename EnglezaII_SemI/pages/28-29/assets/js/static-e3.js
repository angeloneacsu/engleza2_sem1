function static_click3(data_obj) {
...
static_click3.prototype.init = function() {
...
//    $("#" + this.html_hook_id + ' .title').html(this.data_obj.titlu);
    ...
    $("#" + this.html_hook_id + ' .top ').append("<p class='unit_title'>" + this.data_obj.unit_title + "</p>");$("#" + this.html_hook_id + ' .start_nr').html(this.data_obj.nr_exercitiu);
...
static_click3.prototype.add_events = function() {
    _this = this;
    ...
    $("#" + this.html_hook_id + ' .onclick_show').unbind('click');
    $("#" + this.html_hook_id + ' .onclick_show').on('click', function(e) {
        e.preventDefault();
    ...
    /*static type2- on click fadein the element child element 'item_ch' */
     $("#" + this.html_hook_id + ' .clicl_elem').unbind('click');
    $("#" + this.html_hook_id + ' .clicl_elem').on('click', function() {
...
$(document).ready(function() {
    var item_static_click3 = new static_click3(obj_static_ex3);

    $('.static_container').on('vclick', function(e) {
        e.preventDefault();

        if ($(this).attr('data-gameId') == 'item_static_click3') {
            item_static_click3.init();
        }
