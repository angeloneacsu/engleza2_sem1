...
gameType_correctInputValue.prototype.init = function() {  activ_help_btn = true;
...
gameType_correctInputValue.prototype.add_events = function() {
   var _this = this;
    ...
    $('#' + this.html_hook_id + ' .reia_sarcina').on("vclick", function() {_this.init();});$('#' + this.html_hook_id + ' .verificare').on("vclick", function() {
...
gameType_correctInputValue.prototype.take_action = function() { activ_help_btn = false;
...
gameType_correctInputValue.prototype.show_correct = function() { activ_help_btn = false;
    _this = this;
