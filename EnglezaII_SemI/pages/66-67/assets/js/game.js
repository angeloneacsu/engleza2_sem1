...
//    });
    ...
    $("#" + this.html_hook_id + ' .draggable_container .ui-draggable').each(function(index, value) {
        ...
        $('img', this).attr('src', "assets/images/game/" + arr_start_page[index].valoare);
    });
...
gameType_gradAndDrop.prototype.reset = function(event, ui) {
    $("#" + this.html_hook_id + ' .ui-draggable').draggable({
        containment: '#drag_container1',
        stack: '#droppable_container1 .ui-droppable',
        cursor: 'move',
        revert: true
    });
    $("#" + this.html_hook_id + ' .ui-droppable').droppable({
        accept: '#draggable_container1 .ui-draggable',
        hoverClass: 'hovered',
...
gameType_gradAndDrop.prototype.verifica = function() {
    ...
    $('#eval_gm1').html(corect * 5 + add_bonus);
    var curr_rez = corect * 5 + add_bonus;
    var gm1, gm2, gm3, gm4;
