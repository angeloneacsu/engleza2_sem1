...
gameType_correctOrder.prototype.init = function() {
    activ_help_btn = true;
    $("#" + this.html_hook_id + '  .sunet').removeClass('invizibil');
    ...
    $('.checkbox-holder div,.error,.response ').removeClass('true checked c_true c_false c_uncheck_true c_uncheck_false');
...
gameType_correctOrder.prototype.add_events = function() {
    ...
    $('#' + this.html_hook_id + " input.response").keypress(function(e) {
...
gameType_correctOrder.prototype.verifica = function() {
    ...
    $(data).each(function(index, value) {
        ...
        $('.checkbox-holder input', this).each(function(index, value) {
            if (($(this).attr('data-status').toLowerCase() == $(this).val().toLowerCase())) {
                valid = true;
                elem_obj = $(this);
    ...
    $("#" + this.html_hook_id + '  .sunet').addClass('invizibil');
    this.take_action();

};

gameType_correctOrder.prototype.take_action = function() {
...
gameType_correctOrder.prototype.show_correct = function() {
    activ_help_btn = false;
    _this = this;
