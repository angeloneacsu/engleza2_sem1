...
//    this.arr_usable_elem = $.map(data_obj.elemente, function(value, index) {
//        return value;
//    });
...
gameType_multipleChoice.prototype.init = function() {  activ_help_btn = true;
    ...
    $('.ajutor').attr('data-audio', this.data_obj.ajutor.sunet);
    $('.help_text').html(this.data_obj.ajutor.text);
//                $('.placeholder .container').attr('data-audio', data.sarcina.sunet);
...
gameType_multipleChoice.prototype.verifica = function() {
    ...
    if (this.is_verification_started || $('.verificare').hasClass('inactiv')) {
...
$(document).ready(function() {
    var game = new gameType_multipleChoice(game_data);
    $('.checkbox-holder .response').on("click", function() {
        $(this).parent().find('.response').removeClass('checked');
        $(this).addClass('checked');
    });
    $('.verificare').on("click", function() {
        game.verifica();
    });
    ...
    $('.gm_container').on('vclick', function(e) {
        e.preventDefault();
        game.init();
        play_audio($('#frame .container'));
//		is_verification_started = false;        
        $('.verificare').removeClass('inactiv');
        /*$('#frame .placeholder').html($(this).html());*/
        $('.section').hide();
        $('.game_frame').show();
